...
$translations = [
    'en' => [
        ...
        'formula_desc_classic_elo'       => 'Players are ranked by their ELO rating. Each match updates ratings using the standard ELO formula with FIDE-style K factors (K=40 for new players, K=20 below 2200, K=10 above 2200). Climb the standings by defeating higher-rated opponents — the bigger the upset, the more points you gain.',
        'formula_desc_ladder_no_draw'    => 'A ladder ranking where draws are not allowed — every match must have a winner. Defeat a higher-ranked opponent to take their position and move up the standings. All results are final; there are no draws.',
        'formula_desc_knockout_no_draw'  => 'An elimination-style ranking without draws. Players compete in knockout matches; defeat your opponent to advance. No draws are permitted — every match must produce a clear winner.',
        'formula_desc_ladder_3up_sliding'=> 'A sliding ladder ranking. You may only challenge players within 3 positions above you. If you win, you take their exact position and all players in between slide down one spot. ELO rating is tracked and shown for reference only — the actual ranking is determined by position.',
        'formula_desc_mobile_ranking'    => 'A position-based ranking driven by direct matches. Beat a higher-ranked opponent and you take their position — all players between slide down one spot. ELO is calculated and shown for analysis only; the official ranking is determined by match results. All circuit players appear in the standings from day one, even before their first match.',
    ...
    'it' => [
        ...
        'formula_desc_classic_elo'       => 'I giocatori sono classificati per rating ELO. Ogni partita aggiorna i rating con la formula ELO standard e fattori K stile FIDE (K=40 per nuovi giocatori, K=20 sotto 2200, K=10 sopra 2200). Scala la classifica battendo avversari con rating più alto — più è sorprendente il risultato, più punti guadagni.',
        'formula_desc_ladder_no_draw'    => 'Una classifica a scaletta dove i pareggi non sono ammessi — ogni partita deve avere un vincitore. Batti un avversario classificato più in alto per prendere il suo posto. Nessun pareggio consentito: ogni incontro deve produrre un vincitore.',
        'formula_desc_knockout_no_draw'  => 'Una classifica in stile eliminazione diretta senza pareggi. I giocatori si sfidano in incontri a eliminazione; batti il tuo avversario per avanzare. Nessun pareggio ammesso — ogni partita deve produrre un vincitore netto.',
        'formula_desc_ladder_3up_sliding'=> 'Una classifica a scaletta scorrevole. Puoi sfidare solo giocatori entro 3 posizioni sopra di te. Se vinci, prendi il loro esatto posto in classifica e tutti i giocatori intermedi scorrono di una posizione verso il basso. Il rating ELO viene tracciato e mostrato solo come riferimento — la classifica effettiva è determinata dalla posizione.',
        'formula_desc_mobile_ranking'    => 'Una classifica basata sulla posizione e determinata dagli scontri diretti. Batti un avversario classificato più in alto e ne prendi il posto — tutti i giocatori intermedi scorrono di una posizione verso il basso. L\'ELO viene calcolato e mostrato solo a fini di analisi; la classifica ufficiale è determinata dai risultati delle partite. Tutti i giocatori del circuito compaiono in classifica fin dal primo giorno, anche prima della loro prima partita.',
