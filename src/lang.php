...
$translations = [
    'en' => [
        ...
        'formula_desc_mobile_ranking'    => 'This ranking is position-based and driven by direct matches. To climb it, beat a higher-ranked opponent and you take their position — all players in between slide down one spot. The ELO shown here is calculated for analysis only; the official standing is determined solely by match results. All circuit players appear in this ranking from day one, even before their first match.',
